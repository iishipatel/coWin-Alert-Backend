    ...
    with app.app_context():
        ...
        for x in range (1,len(values)):
            ...
            if (values[x][5]=='18+'):
                ...
                age_lim=45
            print (name,email,zipcode,date,age_lim)
